<template>
  <header
    class="sticky top-0 flex w-full bg-[#FEF3E2] border-gray-200 z-10 lg:border-b shadow-md" 
  >
    <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
      ...
      <div
        ...
        class="items-center justify-between w-full gap-4 px-5 py-4 shadow-theme-md lg:flex lg:justify-end lg:px-0 lg:shadow-non "
      >
        <NotificationMenu v-if="role === 'ahli_gizi'" />
        <UserMenu />
      </div>
    </div>
  </header>
